                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 lg:py-20 w-full">
                    <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-12">
                        ...
                        <div className="flex-1 w-full text-center lg:text-left">
                            <div className="inline-flex items-center gap-2 mb-6 px-4 py-2 bg-gradient-to-r from-blue-600 to-cyan-600 text-white rounded-full text-sm sm:text-base font-bold border-2 border-white shadow-xl">
                            ...
                            <div className="flex flex-col sm:flex-row gap-4 mb-8 max-w-md mx-auto lg:mx-0">
                                <Link href="/register" className="flex-1">
                                    <Button
                                        size="lg"
                                        className="w-full shadow-xl text-base sm:text-lg bg-gradient-to-r from-blue-600 to-cyan-600 hover:shadow-2xl transition-all font-bold text-white"
                                    >
                                        <UploadIcon size={20} />
                                        Get Started
                                    </Button>
                        ...
                        <div className="flex-1 w-full max-w-lg lg:max-w-none mt-8 lg:mt-0">
                            <div className="relative w-full p-6 sm:p-8 rounded-2xl bg-white dark:bg-gray-900 border-2 border-gray-200 dark:border-gray-700 shadow-2xl">
                                ...
                                {/* Floating Icons */}
                                <div className="absolute -top-4 -right-4 w-12 h-12 sm:w-14 sm:h-14 flex items-center justify-center bg-gradient-to-br from-cyan-600 to-blue-600 rounded-2xl shadow-xl animate-bounce-rotate border-2 border-white dark:border-gray-800">
                                    <SparklesIcon
                                        size={24}
                                        className="text-white"
                                    />
                                </div>
                                <div className="absolute -bottom-4 -left-4 w-12 h-12 sm:w-14 sm:h-14 flex items-center justify-center bg-gradient-to-br from-blue-600 to-cyan-600 rounded-2xl shadow-xl animate-bounce-rotate border-2 border-white dark:border-gray-800">
                                    <BrainIcon
                                        size={24}
                                        className="text-white"
                                    />
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
                        {features.map((feature, index) => (
                            ...
                            >
                                <div className="w-14 h-14 flex items-center justify-center bg-gradient-to-br from-blue-600 to-cyan-600 rounded-xl mb-4 group-hover:scale-110 transition-transform shadow-lg">
                                    <feature.icon
                                        size={28}
                                        className="text-white"
                                    />
